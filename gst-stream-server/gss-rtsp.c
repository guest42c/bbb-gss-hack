...
gss_rtsp_stream_start (GssRtspStream *rtsp_stream)
{
  ...
  rtsp_stream->mapping = gst_rtsp_server_get_media_mapping (rtsp_stream->server);
  gst_rtsp_media_mapping_add_factory (rtsp_stream->mapping, "/stream", rtsp_stream->factory);
